...
describe('Testing the array:', () => {
    ...
    test('matches even if received contains additional elements', () => {
        expect(
            someArray(['apple', 'lime', 'avocado', 'banana', 'lemon'])
        ).toEqual(expect.arrayContaining(arr));
    });
